package com.example.uberv.learningdagger2.data;
...
@Singleton // register this class as singleton in the dependency graph
public class DbHelper extends SQLiteOpenHelper {
    ...
    @Inject // make dagger accumulate all the parameter dependencies
    public DbHelper(@ApplicationContext Context context, // get context of the application from dagger's dependency graph
